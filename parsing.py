"""Parsing utilities for LLM responses and data processing.

This module provides functions for parsing CSV-like LLM outputs, sanitizing
job titles, determining skip reasons, and parsing batch API JSONL responses.
