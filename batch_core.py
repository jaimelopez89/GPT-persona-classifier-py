"""Core utilities for OpenAI Batch API operations.

This module provides functions for uploading files, creating batch jobs, polling
for completion, and downloading results from OpenAI's Batch API. Includes ETA
estimation and resilient polling with exponential backoff.
