"""Configuration module for persona classification project.

This module contains all configuration constants including model names, rate limiting
parameters, file paths, and valid persona definitions.
