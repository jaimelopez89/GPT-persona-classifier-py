"""I/O utilities for file operations and data loading.

This module provides functions for loading environment variables, reading/writing
files, filtering data, and managing output directories.
