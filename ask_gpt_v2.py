"""Enhanced utility module for calling OpenAI Chat API with system/user messages.

This module provides a function to call OpenAI's chat completion API with
separate system and user messages, allowing for more structured prompts.
