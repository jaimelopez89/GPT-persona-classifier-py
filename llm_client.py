...
This module provides a simplified interface for creating chat sessions and
making API calls to OpenAI's chat completion endpoint. It's a streamlined
version of gpt_functions.py used by the streaming enricher.
