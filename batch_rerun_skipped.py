#!/usr/bin/env python3
"""Batch rerun script for processing skipped prospects.

This script takes a CSV file of previously skipped prospects and reruns them
through the Batch API. It merges new results with existing data, preserving
any previously valid classifications.
